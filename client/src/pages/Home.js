...
const Home = () => {
  ...
  async function createProposal(newProposal, addresses) {
    console.log(addresses.split(",").map(el => el.trim()))
    let options = {
      contractAddress: "0x8c5E69EB4D1a8237331DDFADe10C3FafbcF39eA6",
      ...
      params: {
        desc: newProposal,
        canVote: addresses.split(",").map(el => el.trim()),
      },
    };
  ...
  async function getStatus(proposalId) {
    const ProposalCounts = Moralis.Object.extend("proposalsConcluded");
            ...
            <div className="tabContent">
              ...
              <Form
                  ...
                  data={[
                    ...
                    {
                      inputWidth: "100%",
                      name: "Addresses Eligigble to Vote",
                      type: "textarea",
                      validation: {
                        required: true,
                      },
